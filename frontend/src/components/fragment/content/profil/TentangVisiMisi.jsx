  ...
  return (
    <div className="w-full p-1 flex flex-col items-center">
      ...
      <div className="w-full md:w-4/5">
        <h1 className="text-2xl my-4 font-semibold text-center border-b-black border-b p-2 lg:my-10">
          VISI, MISI DAN TUJUAN SMKN 1 GEDANGAN
        </h1>
        <p className="text-xl my-4">1. Visi Sekolah</p>
        <p>
        ...
        <p className="text-xl my-4">2. Misi Sekolah</p>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur
          temporibus consequuntur debitis. A, est magnam sed, harum cupiditate
          tenetur iste id quae veniam illum adipisci nisi dolore dolores impedit
        ...
        <p className="text-xl my-4">3. Tujuan Sekolah</p>
        <p>
          Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur
          temporibus consequuntur debitis. A, est magnam sed, harum cupiditate
          tenetur iste id quae veniam illum adipisci nisi dolore dolores impedit
