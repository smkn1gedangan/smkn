...
const Sambutan = () => {
  ...
  return (
    <div className="  ">
      <div>
        <h1 className="fontPrimary text-center text-xl mt-10 mb-5 lg:mt-14 lg:text-3xl ">
          Sambutan Kepala Sekolah
        </h1>
        <div className="w-full flex flex-wrap justify-center lg:p-4 lg:flex-row-reverse">
          <div className="w-full lg:w-1/2 lg:flex lg:items-center ">
            <p className="text-center w-full text-sm p-2 lg:text-base font-serif">
