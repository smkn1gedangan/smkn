...
const TextArea = ({ inputChange, inputValue, onHandleSubmit, id }) => {
  ...
  return (
    <div className="w-full flex flex-wrap gap-10 justify-center">
      <div
        onClick={handleImage}
        className="w-1/4 border border-black flex justify-center max-md:w-full"
      >
        {image ? (
          <img
      ...
      <div className="w-3/5 items-center flex justify-center flex-wrap">
        ...
        <button
          ...
          className="bg-blue-600 outline-none border-none mt-4 p-2 md:w-2/6 rounded-lg text-white font-semibold transition-all duration-300 hover:bg-blue-500 w-full "
        >
          kirim
        </button>
      </div>
